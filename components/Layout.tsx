...
export default function Layout({ children, title, subTitle }: Props) {
  return (
    <motion.div 
      className='overflow-hidden relative w-full h-screen flex flex-col items-center justify-center gap-3 my-1'
      initial={{
        opacity: 0
      }}
      whileInView={{
    ...
    >
      <div className='flex flex-col items-center justify-center gap-y-2 h-1/6'>
